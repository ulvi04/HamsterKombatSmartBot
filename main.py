...
LOGFORMAT = "%(log_color)s[Ulvi Abbasli]%(reset)s[%(log_color)s%(levelname)s%(reset)s] %(asctime)s %(log_color)s%(message)s%(reset)s"
...
def main():
    log.info("------------------------------------------------------------------------")
    log.info("------------------------------------------------------------------------")
    log.info("\033[1;32mWelcome to [Ulvi Abbasli] Auto farming bot...\033[0m")
    log.info(
        "\033[1;34mProject Github: https://github.com/ulvi04/HamsterKombatSmartBot\033[0m"
    )
    log.info("\033[1;33mDeveloped by: Ulvi Abbasli\033[0m")
    log.info("\033[1;35mVersion: 1.0\033[0m")
